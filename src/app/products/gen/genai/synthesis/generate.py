...
from src.app.products.gen.genai.synthesis.config import CTGANArtifactConfig
from src.app.products.gen.genai.synthesis.contracts import CTGANGenerationResult
