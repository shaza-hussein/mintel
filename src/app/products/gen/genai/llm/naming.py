...
from src.app.products.gen.genai.llm.prompts import nomenclator_prompt
...
class Nomenclator:
    ...
    def naming(self, bundles: str) -> Optional[Dict[str, Any]]:
        prompt = nomenclator_prompt(bundles=bundles)
